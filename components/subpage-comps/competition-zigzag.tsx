      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <br></br>
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <div className="inline-flex text-sm font-semibold py-1 px-3 m-2 text-green-600 bg-green-200 rounded-full mb-4">Currently Running</div>
            <h1 className="h2 mb-4">Kaggle Competition</h1>
            <p className="text-xl text-gray-400">Enter a Data Science AI competition that we're hosting on Kaggle!</p>
          </div>
